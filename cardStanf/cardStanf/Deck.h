...
- (void)addCard:(EVXCard *)card atTop:(BOOL)atTop; // note two args & the name is addCard_atTop
- (void)addCard:(EVXCard *)card; // this makes addCard have options to either add a card or add a card at the top of the deck.
